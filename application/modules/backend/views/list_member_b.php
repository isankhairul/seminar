			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						...
						<input type="text" name="search_member" class="form-control" id="search_member" placeholder="search By EMAIL / NAMA" value="<?php $session_searchMahasiswa = $this->session->userdata('pencarian_member'); echo (!empty($session_searchMahasiswa)) ? $session_searchMahasiswa : ''?>" />     
